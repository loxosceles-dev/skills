...
**Audience**: Service developers (Lambda, ECS, frontend). If you're using CDK to deploy infrastructure, see [CDK Bootstrap Configuration](../cdk-bootstrap-configuration/SKILL.md).
...
- **[CDK Bootstrap Configuration](../cdk-bootstrap-configuration/SKILL.md)** - For CDK projects: how to write outputs to SSM without causing context caching issues
- [Environment Validation](../environment-validation/SKILL.md) - Validate config early
- [Environment Deployment Strategy](../environment-deployment-strategy/SKILL.md) - How environments are deployed
- [Security Baseline](../core-principles/SKILL.md#8-security-baseline) - Secret management principles
